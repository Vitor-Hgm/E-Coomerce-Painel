...
<head>
    ...
    <title>Cadastrar Categoria - Ecommerce Painel</title>
...
<body class="p-4">
    ...
    <div class="card-form">
        <h3>Preencha os detalhes da categoria</h3>
        <form action="/E-Coomerce-Painel/public/categoria/store" method="POST">
            <!-- Nome -->
            <div class="mb-3">
    ...
    <script>
        ...
        nameInput.addEventListener('input', function () {
            ...
            slug = slug.replace(/[^a-z0-9-]+/g, '-'); // substitui caracteres especiais por "-"
            slug = slug.replace(/-+/g, '-'); // remove múltiplos hífens consecutivos
